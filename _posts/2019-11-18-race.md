...
- 解释的最精炼准确的：[CVE-2016-5195 DirtyC0w: Linux内核提权漏洞分析](http://www.nsoad.com/Article/Vulnerabilityanalysis/20161025/634.html)
...
- 在mmap中利用PROT_READ,MAP_PRIVATE触发COW机制，然后利用条件竞争卸载当前页表
- 利用/proc/self/mem强行写入物理内存页，触发page cache的写回机制
