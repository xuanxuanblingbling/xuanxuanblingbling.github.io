...
- hci报文（wireshark抓取主机hci接口）：[adv_hci.pcapng](https://xuanxuanblingbling.github.io/assets/attachment/bluetooth/adv_hci.pcapng)
...
- 问：基本所有的手机或者电脑本身都是支持蓝牙的，那为什么还需要一些其他的外置硬件才能进行某些场景下的安全研究呢？
- 答：研究一个通信的过程，黑客主要有五个动作：收、发、抓、断、改。本机的硬件可能不支持某些动作，比如发畸形报文，比如抓空中其他设备的通信报文等等。
