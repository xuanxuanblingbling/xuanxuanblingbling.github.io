...
- 后来发现文章 [Linux Rootkit 系列五：感染系统关键内核模块实现持久化](https://docs-conquer-the-universe.readthedocs.io/zh_CN/latest/linux_rootkit/persistence.html) 直接劫持init_module符号，可一步到位
