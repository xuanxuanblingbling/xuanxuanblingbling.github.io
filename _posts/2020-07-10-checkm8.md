...
在分析这个漏洞之前，先对checkm8有一个感性直观的认识，我们首先动动手，做俩实验：分别是使用checkra1n越狱，以及使用ipwndfu提取固化在处理器芯片中的固件代码（SecureROM）。
...
一切的开始，让我们来看一条2018年的新闻：

- [史上最大源码泄露事件：iOS 关键源代码被匿名公布在 GitHub 上](https://mp.weixin.qq.com/s/YrZPxHttM4qoVgqz1YApJw)
