...
ctf的pwn教学一般的漏洞在二进制，利用在python。而[how2heap](https://github.com/shellphish/how2heap)的漏洞和利用都在c源码中，利用gdb调用函数的方法，可以让漏洞和利用都落实在gdb命令中，如这个在libc2.31下的堆越界写打tcache的fd：
