...
至此我们可以回答：**各种结构体的名称不是极客们逆向出来的，而是微软提供的。** 虽然ntdll这些动态链接库删去了符号表，但是为了方便调试，还是要放出一些符号信息给开发者。这些符号信息就是理解Windows背后机制的重要资料，因为符号蕴含了变量、函数、结构体等程序中关键信息的含义。有了符号，我们就可以“望文生义”，通过符号去大致了解变量、函数、结构题的用途，并最终帮助我们理解程序的意图。一个没有符号的程序，就像逻辑代数的真值表，程序work，但是人类却无法直接想清楚，这个程序是干啥的。找到一个站点[vergiliusproject](https://www.vergiliusproject.com/)，非常酷炫也非常好看，帮我们梳理了微软所提供的这些结构体信息，比如[_HEAP](https://www.vergiliusproject.com/kernels/x64/Windows%2010%20%7C%202016/2004%2020H1%20(May%202020%20Update)/_HEAP)。
...
| 安全机制 | [ASLR, DEP, Canary, SafeSEH, ControlFlowGuard](https://www.kanxue.com/book-8-66.htm)   | [PIE, NX, Canary, RELRO](https://introspelliam.github.io/2017/09/30/linux%E7%A8%8B%E5%BA%8F%E7%9A%84%E5%B8%B8%E7%94%A8%E4%BF%9D%E6%8A%A4%E6%9C%BA%E5%88%B6/) |
