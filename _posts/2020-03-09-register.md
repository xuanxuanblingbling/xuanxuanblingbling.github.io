...
既然说模拟器，那肯定少不了qemu了！是这篇文章给我的启发：[Qemu对内部寄存器的模拟](http://blog.chinaunix.net/uid-29141031-id-5090819.html)，去找了CPUX86State这个结构体：
...
所以，就像上面的回答所说，已知的寄存器个数实际很多，而且CPU的确存在着那些没有公开的寄存器。那他们在做着不为人知的事呢？
