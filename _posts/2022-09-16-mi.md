...
```python
cmd =  "/usr/bin/wget --no-check-certificate https://busybox.net/downloads/binaries/1.21.1/busybox-armv7l -O /data/busybox;"
...
```c
# cat /proc/version 
Linux version 4.9.118 (jenkins@b7c900009d2c) (gcc version 6.4.1 (OpenWrt/Linaro GCC 6.4-2017.11 2017-11) ) #1 SMP Sun Jan 19 10:57:28 UTC 2020
